        ...
        <section id="About" class="background container-fluid aboutSection">
            <div class="row mx-5">
                <div class="col-md-5 flex">
                    <img src="/assets/images/Headshot.png" class="headshot"></img>
                ...
                <div class="col-md-7">
                    ...
                    <p>
                        When I'm coding, I enjoy working with my dog, Rweck, <span class="font-weight-light font-italic">-As in wrecking ball. It fits. Trust me.-</span> backpacking, rock climbing, or relaxing and geeking out on some video games. 
                    </p>
                    <p>
                        My previous job, training dogs and managing a dog training facility and kennel, granted me lots of experience with managing small teams, being flexible and comfortable with jumping in to help on projects where needed, and maintinaing a positive work environemnt.
                    </p>
                </div>
            </div>
        </section>
